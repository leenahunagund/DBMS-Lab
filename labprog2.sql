...
DELETE FROM OWNS
WHERE regno = 'JKL345'
AND driver_id IN (SELECT driver_id FROM PERSON WHERE dname like '%Smith%');
select *from owns;
...
INSERT INTO ACCIDENT VALUES (14, '2020-01-12', 'Intersection A');
INSERT INTO PARTICIPATED VALUES('D5','JKL345',14,1800);
/*  worked!*/